<template>
  <div>
    <Navbar></Navbar>
    <main class="md:pt-16">
      <section class="pt-14 pb-20 bg-gray-50">
        <div class="container mx-auto flex py-10">
          <div
            class="flex flex-col mb-16 space-y-6 text-center xl:items-start xl:flex-grow xl:pr-20 xl:w-1/2 md:mb-0 xl:text-left z-10"
          >
            <h1
              class="text-3xl dark:text-gray-100 md:text-6xl text-black font-bold tracking-tight"
            >
