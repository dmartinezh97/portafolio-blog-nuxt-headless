    ...
    <main class="container mx-auto pt-16">
      <section class="py-10">
        ...
        <div id="articulos" class="grid grid-cols-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4 px-4">
          <NuxtLink v-for="articulo in articulos" :key="articulo.slug" :to="'/articulo/' + articulo.slug" class="flex flex-col items-start col-span-4 sm:col-span-1 md:col-span-1 overflow-hidden shadow-sm hover:shadow-lg rounded-xl">
